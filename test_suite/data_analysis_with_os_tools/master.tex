...
% ABD: \paragraph and \subparagraph map to sect4 and sect5, which
% have to be properly nested in XML.  The author is using them here
% when he should probably be using the description environment,
% so I am replacing these commands with textbf

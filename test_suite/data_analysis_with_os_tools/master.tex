...
\include{univariate} % done
\include{bivariate} % done
\include{timeseries} % done
\include{multivariate} % done
\include{session} % done
...
\include{guesstimation} % done
\include{scaling} % done
\include{probability} %done
\include{statistics} % done
\include{bigfoot} % done
...
\include{simulation} % done
\setcounter{chapter}{12}
\include{clustering} % done
\include{reduction} % done
\include{moredifferent} % done
...
\include{buzzwords} % done
\include{business} % done
\include{prediction} % done
 \include{epilogue} % done
